...
let singleLine = str => `${str.toUpperCase()}!!!`
...
console.log(bestMovie('Pirates of the Caribbean'))
...
function sampleStringUpper(str) {
  let upperLetters = sampleString.toUpperCase()
  console.log(upperLetters)
}

sampleStringUpper(sampleString)
...
console.log(emailCheck('kevman99@comcast.net'))
...
let totalFrogs = chocolateFrogs(500)
...
let totalFrogs2 = chocolateFrogs2(500)
